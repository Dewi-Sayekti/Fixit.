...
<div class="map-container">
    ...
    <div class="map-svg">
        <?php echo $__env->make('svg.baitur', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>    

    <div id="bbox" class="bounding-box"></div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $zona; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="poly-click"
             data-id="<?php echo e($z->id); ?>"
             data-nama="<?php echo e($z->nama); ?>"
             data-rating="<?php echo e($z->rating_agg); ?>"
             style="
                left:<?php echo e($minX); ?>px;
                top:<?php echo e($minY); ?>px;
                width:<?php echo e($maxX - $minX); ?>px;
                height:<?php echo e($maxY - $minY); ?>px;
             ">
        </div>
...
<div class="list-tile">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'santri'): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const zonas = <?php echo json_encode($zona->keyBy('id'), 15, 512) ?>;
...
<?php /**PATH C:\Users\Tiara Mustika\Downloads\fixit\resources\views/jelajah.blade.php ENDPATH**/ ?>