...
<div class="wrapper">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <div class="filter-dropdown-container">
            ...
            <div class="filter-menu" id="filterMenu">
                <a href="<?php echo e(route('aduan.index')); ?>" class="filter-option <?php echo e(!$statusFilter ? 'active' : ''); ?>">• semua</a>
                <a href="<?php echo e(route('aduan.index', ['status' => 'diadukan'])); ?>" class="filter-option <?php echo e($statusFilter === 'diadukan' ? 'active' : ''); ?>">• diadukan</a>
                <a href="<?php echo e(route('aduan.index', ['status' => 'diproses'])); ?>" class="filter-option <?php echo e($statusFilter === 'diproses' ? 'active' : ''); ?>">• diproses</a>
                <a href="<?php echo e(route('aduan.index', ['status' => 'perbaikan selesai'])); ?>" class="filter-option <?php echo e($statusFilter === 'perbaikan selesai' ? 'active' : ''); ?>">• selesai</a>
            </div>
        </div>
    </div>
    ...
    <div class="tile">
        ...
        <div class="tile-text">
            ...
            <div class="timestamp">
                tanggal ajukan <?php echo e($a->created_at->format('d F Y')); ?> jam <?php echo e($a->created_at->format('H:i')); ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($a->status === 'perbaikan selesai'): ?>
                    <br>
                    tanggal selesai <?php echo e($a->updated_at->format('d F Y')); ?> jam <?php echo e($a->updated_at->format('H:i')); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('zona') && Auth::user()->role==='santri'): ?>
...
</html><?php /**PATH C:\Users\Tiara Mustika\Downloads\fixit\resources\views/aduan.blade.php ENDPATH**/ ?>